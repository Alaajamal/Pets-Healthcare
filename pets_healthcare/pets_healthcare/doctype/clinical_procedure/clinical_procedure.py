...
class ClinicalProcedure(Document):
	...
	def make_material_transfer(self):
		...
		expense_account = get_account(None, "expense_account", "Pets Healthcare Settings", self.company)
		for item in self.items:
...
def create_stock_entry(doc):
	...
	expense_account = get_account(None, "expense_account", "Pets Healthcare Settings", doc.company)
